...
/*Theme Itself*/
	...
	#app-mount .pill-31IEus .item-2hkk8m {background-color: var(--secondary1-colour)}
	...
	#app-mount .contentColumn-2hrIYH {max-width: 90%;padding: 60px 30px 80px}
		...
		#app-mount .item-26Dhrx[style*="rgb(114, 137, 218)"] .checkbox-1ix_J3 {background-color: var(--activetext-colour)!important; border-color: transparent!important;}
		#app-mount .item-26Dhrx[style*="rgb(114, 137, 218)"] {background-color: var(--primary1-colour)!important; border-color: var(--primary1-colour)!important;} 
		#app-mount polyline[stroke='#7289da'] {stroke:var(--primary1-colour)}
		...
		#app-mount .item-26Dhrx {border-color: transparent;}
	...
	#app-mount .typeWindows-1za-n7:after {
		content: "GGO Kirito v1.2.1 By VaporousCreeper";
